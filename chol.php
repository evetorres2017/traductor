				...
				<fieldset>
					...
					<p>
					  <select name="traducir">
					    ...
					    <option value="2">Ch'ol-Espa&ntilde;ol</option>
					    <option value="3">Espa&ntilde;ol-Ch'ol</option>
						<option value="4">Ch'ol-Ingl&eacute;s</option>
					    <option value="5">Ingl&eacute;s-Ch'ol</option>
				      </select>
					</p>				
			...
			if(isset($_POST['enviar'])){
				...
				switch($opcion){
					...
					case 1: // Español a Ingles
						...
						break;
					case 2: // Ch'ol a Español
						require_once("php/choEsp.php");
						break;
					case 3: // Español a Ch'ol
						require_once("php/espCho.php");
						break;
					case 4: // Ch'ol a Ingles
						require_once("php/choIng.php");
						break;
					default: // Ingles a Ch'ol
						require_once("php/ingCho.php");
				} // Fin del switch				
