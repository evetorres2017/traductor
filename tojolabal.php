				...
				<fieldset>
					...
					<p>
					  <select name="traducir">
					    ...
					    <option value="2">Tojol-aba'l-Espa&ntilde;ol</option>
					    <option value="3">Espa&ntilde;ol-Tojol-aba'l</option>
						<option value="4">Tojol-aba'l-Ingl&eacute;s</option>
					    <option value="5">Ingl&eacute;s-Tojol-aba'l</option>
				      </select>
					</p>				
			...
			if(isset($_POST['enviar'])){
				...
				switch($opcion){
					...
					case 1: // Español a Ingles
						...
						break;
					case 2: // Tojol-aba'l a Español
						require_once("php/tojEsp.php");
						break;
					case 3: // Español a Tojol-aba'l
						require_once("php/espToj.php");
						break;
					case 4: // Tojol-aba'l a Ingles
						require_once("php/tojIng.php");
						break;
					default: // Ingles a Tojol-aba'l
						require_once("php/ingToj.php");
				} // Fin del switch				
