...
<form name="form1" method="post" action="">
  ...
  <p>Palabra en tsotsil:   
    <input name="txtTsotsil" type="text" maxlength="20" required/>
  </p>
  <p>Palabra en tojolabal:   
    <input name="txtTojolabal" type="text" maxlength="20" required/>
  </p>
  <p>Palabra en chol:   
    <input name="txtChol" type="text" maxlength="20" required/>
  </p>
  <p>
...
if(isset($_POST['btnEnviar'])){
	...
	$sql = "INSERT INTO tinformacion (espanol, ingles, tseltal, chol, tsotsil, tojolabal) ";
	$sql .= "VALUES ('$espanol', '$ingles', '$tseltal', '$chol', '$tsotsil', '$tojolabal')";
